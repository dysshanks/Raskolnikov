...
- Repository: `github.com/raskolnikov-security/raskolnikov`
- Apache-2.0 license
...
```bash
wget https://github.com/raskolnikov-security/raskolnikov/releases/download/v0.1.0/raskolnikov_0.1.0_amd64.deb
wget https://github.com/raskolnikov-security/raskolnikov/releases/download/v0.1.0/raskolnikov_0.1.0_amd64.deb.sig
